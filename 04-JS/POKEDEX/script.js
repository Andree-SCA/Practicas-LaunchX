...
const renderPokemonAbilities = abilities => {   
    ...
    abilities.forEach(ability => {
        const abilityElemnet = document.createElement("div");
        const abilityElemnetName = document.createElement("div");
        abilityElemnetName.textContent = ability.ability.name;
        abilityElemnet.appendChild(abilityElemnetName);
        pokeAbilities.appendChild(abilityElemnet);    
    });
}
